...
var s = new MutablePoint();
var c = new MutableBox();
var listS = new List<MutablePoint> { s };
var listC = new List<MutableBox>   { c };

s.X = 5; c.X = 5;
Console.WriteLine($"struct in list: {listS[0].X}, class in list: {listC[0].X}");
